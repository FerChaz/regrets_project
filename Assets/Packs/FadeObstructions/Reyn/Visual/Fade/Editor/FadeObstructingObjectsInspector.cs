...
public class FadeObstructingObjectsInspector : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        fade._Camera = (Camera)EditorGUILayout.ObjectField(new GUIContent("Camera", "Fading is camera dependant, we fade the objects between something and the camera"), fade._Camera, typeof(Camera), true);
